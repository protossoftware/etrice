...
class Optional2ReplicatedInterface extends ReplicatedOptionalActorInterfaceBase {
	...
	//--------------------- construction
	public Optional2ReplicatedInterface (IEventReceiver parent, String name) {
		super(parent, name, "Optional2");
