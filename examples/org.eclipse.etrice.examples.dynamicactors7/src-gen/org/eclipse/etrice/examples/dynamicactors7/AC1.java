...
public class AC1 extends ActorClassBase {
	...
	public AC1(IRTObject parent, String name) {
		...
		pin = new PCPort(this, "pin", IFITEM_pin);
	...
	public static final int CHAIN_TRANS_tr0_FROM_Ready_TO_Ready_BY_sayHellopin_tr0 = 2;
	...
	/* Action Codes */
	protected void action_TRANS_tr0_FROM_Ready_TO_Ready_BY_sayHellopin_tr0(InterfaceItemBase ifitem) {
	...
	private int executeTransitionChain(int chain, InterfaceItemBase ifitem, Object generic_data) {
		switch (chain) {
			...
			case CHAIN_TRANS_tr0_FROM_Ready_TO_Ready_BY_sayHellopin_tr0:
			{
				action_TRANS_tr0_FROM_Ready_TO_Ready_BY_sayHellopin_tr0(ifitem);
				return STATE_Ready;
			}
				default:
					/* should not occur */
	...
	public void receiveEvent(InterfaceItemBase ifitem, int evt, Object generic_data) {
		...
		if (!handleSystemEvent(ifitem, evt, generic_data)) {
			switch (getState()) {
				case STATE_Ready:
					switch(trigger) {
							case TRIG_pin__sayHello:
								{
									chain = CHAIN_TRANS_tr0_FROM_Ready_TO_Ready_BY_sayHellopin_tr0;
