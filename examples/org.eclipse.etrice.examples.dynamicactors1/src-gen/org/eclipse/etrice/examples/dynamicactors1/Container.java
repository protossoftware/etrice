...
public class Container extends ActorClassBase {
	...
	public static final int CHAIN_TRANS_tr2_FROM_CreateOptional1_TO_ReceivedHelloAgain_BY_hellop0 = 3;
	...
	protected void entry_ReceivedHelloAgain() {
		...
		while (true) {
			switch (state) {
				...
				case STATE_CreateOptional1:
					...
					return STATE_CreateOptional1;
				case STATE_ReceivedHelloAgain:
					if (!(skip_entry)) entry_ReceivedHelloAgain();
					/* in leaf state: return state id */
					return STATE_ReceivedHelloAgain;
				case STATE_TOP:
