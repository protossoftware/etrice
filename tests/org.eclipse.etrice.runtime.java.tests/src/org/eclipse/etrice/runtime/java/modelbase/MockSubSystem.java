...
public class MockSubSystem extends SubSystemClassBase {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.etrice.runtime.java.modelbase.SubSystemClassBase#createOptionalActor(org.eclipse.etrice.runtime.java.modelbase.OptionalActorInterfaceBase, java.lang.String, int)
	 */
	@Override
	public ActorClassBase createOptionalActor(OptionalActorInterfaceBase ai, String actorClass, String name) {
		return null;
	}
