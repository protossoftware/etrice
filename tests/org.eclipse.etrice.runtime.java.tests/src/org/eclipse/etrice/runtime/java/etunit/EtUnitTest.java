...
public class EtUnitTest extends TestCase {
	...
	public void testSuite() throws IOException {
		...
		assertEquals("contents of line 4", "tc fail 1: #-122#-123#org.eclipse.etrice.runtime.java.etunit.EtUnitTest:55#EXPECT_EQUAL_INT8: expected=-122, actual=-123", lines.get(3));
	}
}
