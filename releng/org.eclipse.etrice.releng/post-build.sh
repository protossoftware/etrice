...
cp ${WORKSPACE}/last_success/deliveries/eTrice-CPP-generator.zip /home/data/httpd/download.eclipse.org/etrice/archives/nightly/generators/eTrice-CPP-generator.zip
