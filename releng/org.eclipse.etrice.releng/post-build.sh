...
rm -Rf /home/data/httpd/download.eclipse.org/etrice/archives/nightly/deliveries
echo 'copy update site'
cp -R ${WORKSPACE}/last_success/site.packed/* /home/data/httpd/download.eclipse.org/etrice/updates/nightly/
echo 'copy zips'
cp -R ${WORKSPACE}/last_success/site.p2.zip/* /home/data/httpd/download.eclipse.org/etrice/archives/nightly/
cp -R ${WORKSPACE}/last_success/deliveries /home/data/httpd/download.eclipse.org/etrice/archives/nightly/
echo 'done'
