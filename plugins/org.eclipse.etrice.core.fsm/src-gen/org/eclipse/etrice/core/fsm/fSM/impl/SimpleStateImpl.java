...
public class SimpleStateImpl extends StateImpl implements SimpleState
{
  ...
  {
    return FSMPackage.Literals.SIMPLE_STATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.SIMPLE_STATE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FSMPackage.SIMPLE_STATE__NAME:
        return getName();
    }
