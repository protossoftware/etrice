...
public class GuardedTransitionImpl extends TransitionChainStartTransitionImpl implements GuardedTransition
{
  ...
  {
    return FSMPackage.Literals.GUARDED_TRANSITION;
  }
  ...
  public NotificationChain basicSetGuard(DetailCode newGuard, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FSMPackage.GUARDED_TRANSITION__GUARD, oldGuard, newGuard);
  ...
  public void setGuard(DetailCode newGuard)
  {
    if (newGuard != guard)
    {
      ...
      if (guard != null)
        msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FSMPackage.GUARDED_TRANSITION__GUARD, null, msgs);
      if (newGuard != null)
        msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FSMPackage.GUARDED_TRANSITION__GUARD, null, msgs);
      msgs = basicSetGuard(newGuard, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.GUARDED_TRANSITION__GUARD, newGuard, newGuard));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FSMPackage.GUARDED_TRANSITION__GUARD:
