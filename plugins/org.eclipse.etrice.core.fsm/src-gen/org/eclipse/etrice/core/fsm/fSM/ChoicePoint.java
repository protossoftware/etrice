...
public interface ChoicePoint extends StateGraphNode
{
   ...
   * @see #setName(String)
   * @see org.eclipse.etrice.core.fsm.fSM.FSMPackage#getChoicePoint_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.etrice.core.fsm.fSM.ChoicePoint#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.etrice.core.fsm.fSM.FSMPackage#getChoicePoint_Docu()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.etrice.core.fsm.fSM.ChoicePoint#getDocu <em>Docu</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
