...
public interface ChoicepointTerminal extends TransitionTerminal
{
   ...
   * @see org.eclipse.etrice.core.fsm.fSM.FSMPackage#getChoicepointTerminal_Cp()
   * @model
   * @generated
   */
  ChoicePoint getCp();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.etrice.core.fsm.fSM.ChoicepointTerminal#getCp <em>Cp</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
