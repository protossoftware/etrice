...
public class ChoicepointTerminalImpl extends TransitionTerminalImpl implements ChoicepointTerminal
{
    ...
    if (cp != null && cp.eIsProxy())
    {
      ...
      if (cp != oldCp)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FSMPackage.CHOICEPOINT_TERMINAL__CP, oldCp, cp));
      }
    }
    return cp;
  }
  ...
  public void setCp(ChoicePoint newCp)
  {
    ...
    cp = newCp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.CHOICEPOINT_TERMINAL__CP, oldCp, cp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FSMPackage.CHOICEPOINT_TERMINAL__CP:
