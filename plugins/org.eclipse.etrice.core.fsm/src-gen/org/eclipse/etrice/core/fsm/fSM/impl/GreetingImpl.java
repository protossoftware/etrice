 ...
 * <ul>
 *   <li>{@link org.eclipse.etrice.core.fsm.fSM.impl.GreetingImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  {
    return FSMPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FSMPackage.GREETING__NAME:
        return getName();
    }
