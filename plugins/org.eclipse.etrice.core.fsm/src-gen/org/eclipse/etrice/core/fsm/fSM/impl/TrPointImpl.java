...
public class TrPointImpl extends StateGraphNodeImpl implements TrPoint
{
  ...
  {
    return FSMPackage.Literals.TR_POINT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.TR_POINT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FSMPackage.TR_POINT__NAME:
        return getName();
    }
