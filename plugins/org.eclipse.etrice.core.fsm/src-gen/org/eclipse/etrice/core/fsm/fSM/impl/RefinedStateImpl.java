...
public class RefinedStateImpl extends StateImpl implements RefinedState
{
    ...
    if (target != null && target.eIsProxy())
    {
      ...
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FSMPackage.REFINED_STATE__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public void setTarget(State newTarget)
  {
    ...
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.REFINED_STATE__TARGET, oldTarget, target));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FSMPackage.REFINED_STATE__TARGET:
