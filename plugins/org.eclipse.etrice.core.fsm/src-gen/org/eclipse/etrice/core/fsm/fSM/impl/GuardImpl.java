...
public class GuardImpl extends MinimalEObjectImpl.Container implements Guard
{
  ...
  public NotificationChain basicSetGuard(DetailCode newGuard, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FSMPackage.GUARD__GUARD, oldGuard, newGuard);
  ...
  public void setGuard(DetailCode newGuard)
  {
    if (newGuard != guard)
    {
      ...
      if (guard != null)
        msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FSMPackage.GUARD__GUARD, null, msgs);
      if (newGuard != null)
        msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FSMPackage.GUARD__GUARD, null, msgs);
      msgs = basicSetGuard(newGuard, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMPackage.GUARD__GUARD, newGuard, newGuard));
  }
