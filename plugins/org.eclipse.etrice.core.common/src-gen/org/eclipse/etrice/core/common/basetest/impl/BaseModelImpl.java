...
public class BaseModelImpl extends MinimalEObjectImpl.Container implements BaseModel
{
  ...
  {
    return BasetestPackage.Literals.BASE_MODEL;
  }
  ...
  public EList<EObject> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<EObject>(EObject.class, this, BasetestPackage.BASE_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BasetestPackage.BASE_MODEL__ELEMENTS:
