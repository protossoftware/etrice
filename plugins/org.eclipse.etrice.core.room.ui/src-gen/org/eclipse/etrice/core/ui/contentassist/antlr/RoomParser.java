		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStandardOperationAccess().getGroup_5_1_1(), "rule__StandardOperation__Group_5_1_1__0");
					...
					put(grammarAccess.getPortOperationAccess().getGroup_5_0_1_1(), "rule__PortOperation__Group_5_0_1_1__0");
					...
					put(grammarAccess.getVarDeclAccess().getRefAssignment_3(), "rule__VarDecl__RefAssignment_3");
					...
					put(grammarAccess.getAttributeAccess().getRefAssignment_5(), "rule__Attribute__RefAssignment_5");
					put(grammarAccess.getAttributeAccess().getDefaultValueLiteralAssignment_6_1(), "rule__Attribute__DefaultValueLiteralAssignment_6_1");
					put(grammarAccess.getAttributeAccess().getDocuAssignment_7(), "rule__Attribute__DocuAssignment_7");
					...
					put(grammarAccess.getStandardOperationAccess().getReturntypeAssignment_5_1_1_0(), "rule__StandardOperation__ReturntypeAssignment_5_1_1_0");
					put(grammarAccess.getStandardOperationAccess().getRefAssignment_5_1_1_1(), "rule__StandardOperation__RefAssignment_5_1_1_1");
					...
					put(grammarAccess.getPortOperationAccess().getReturntypeAssignment_5_0_1_1_0(), "rule__PortOperation__ReturntypeAssignment_5_0_1_1_0");
					put(grammarAccess.getPortOperationAccess().getRefAssignment_5_0_1_1_1(), "rule__PortOperation__RefAssignment_5_0_1_1_1");
