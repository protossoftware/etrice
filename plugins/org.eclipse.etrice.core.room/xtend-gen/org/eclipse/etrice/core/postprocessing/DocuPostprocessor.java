...
public class DocuPostprocessor {
  public void process(final GeneratedMetamodel metamodel) {
    ...
    _builder_244.append("A piece of documentation that can be optionally attached at");
    ...
    EAttribute _attribute_36 = PostprocessingHelpers.getAttribute(cls, "lines");
    ...
    _builder_246.append("An annotation similar to Java annotations that can be used");
    ...
    EReference _reference_129 = PostprocessingHelpers.getReference(cls, "type");
    StringConcatenation _builder_247 = new StringConcatenation();
    _builder_247.append("This is the type of the annotation.");
    _builder_247.newLine();
    PostprocessingHelpers.setDocumentation(_reference_129, _builder_247.toString());
    EReference _reference_130 = PostprocessingHelpers.getReference(cls, "attributes");
    ...
    PostprocessingHelpers.setDocumentation(_reference_130, _builder_248.toString());
    ...
    EAttribute _attribute_37 = PostprocessingHelpers.getAttribute(cls, "key");
    ...
    PostprocessingHelpers.setDocumentation(_attribute_37, _builder_250.toString());
    EReference _reference_131 = PostprocessingHelpers.getReference(cls, "value");
