...
public class DocuPostprocessor {
  public void process(final GeneratedMetamodel metamodel) {
    ...
    _builder_156.append("A binding connects two {@link Port}s.");
    _builder_156.newLine();
    _builder_156.append("To be able to distinguish the ports of two {@link ActorContainerRef}s of the same type");
    _builder_156.newLine();
    ...
    _builder_159.append("A binding end point is a pair of an {@link ActorContainerRef} and a {@link Port} and is used");
    _builder_159.newLine();
    _builder_159.append("to uniquely describe a port of a sub actor. If the actor container ref is {@code null} then");
    _builder_159.newLine();
    ...
    _builder_163.append("Layer connections are used to connect {@link SAPRef}s and {@link ServiceImplementation}s.");
    ...
    _builder_166.append("The super class of");
    _builder_166.newLine();
    _builder_166.append("<ul>");
    _builder_166.newLine();
    _builder_166.append("  ");
    _builder_166.append("<li>{@link RefSAPoint}</li>");
    _builder_166.newLine();
    _builder_166.append("  ");
    _builder_166.append("<li>{@link RelaySAPoint}</li>");
    _builder_166.newLine();
    _builder_166.append("</ul>");
    _builder_166.newLine();
    ...
    _builder_174.append("A means to compose {@link SubSystemClass}es of {@link ActorClass}es. Each ref will");
    ...
    EAttribute _attribute_29 = PostprocessingHelpers.getAttribute(cls, "multiplicity");
    ...
    _builder_177.append("The super class of");
    _builder_177.newLine();
    _builder_177.append("<ul>");
    _builder_177.newLine();
    _builder_177.append("  ");
    _builder_177.append("<li>{@link State}</li>");
    _builder_177.newLine();
    _builder_177.append("  ");
    _builder_177.append("<li>{@link ChoicePoint}</li>");
    _builder_177.newLine();
    _builder_177.append("  ");
    _builder_177.append("<li>{@link TrPoint}</li>");
    _builder_177.newLine();
    _builder_177.append("</ul>");
    _builder_177.newLine();
    ...
    _builder_178.append("The super class of");
    _builder_178.newLine();
    _builder_178.append("<ul>");
    _builder_178.newLine();
    _builder_178.append("  ");
    _builder_178.append("<li>{@link StateStateGraphNode}</li>");
    _builder_178.newLine();
    _builder_178.append("  ");
    _builder_178.append("<li>{@link Transition}</li>");
    _builder_178.newLine();
    _builder_178.append("</ul>");
    _builder_178.newLine();
    ...
    _builder_179.append("The super class of");
    _builder_179.newLine();
    _builder_179.append("<ul>");
    _builder_179.newLine();
    _builder_179.append("  ");
    _builder_179.append("<li>{@link SimpleState}</li>");
    _builder_179.newLine();
    _builder_179.append("  ");
    _builder_179.append("<li>{@link RefinedState}</li>");
    _builder_179.newLine();
    _builder_179.append("</ul>");
    _builder_179.newLine();
    ...
    _builder_183.append("It is executed whenever the actor instance is polled (applies only to");
    _builder_183.newLine();
    ...
    _builder_185.append("A state graph is a directed graph composed of");
    ...
    _builder_191.append("A simple state is the standard case of a @link State}.");
    _builder_191.newLine();
    _builder_191.append("It comprises and <em>entry</em>, <em>exit</em> and <em>do</em> code");
    _builder_191.newLine();
    _builder_191.append("and it can contain another {@link StateGRaph} as sub state");
    _builder_191.newLine();
    ...
    _builder_193.append("A refined state can be used only in a derived {@link ActorClass}.");
    _builder_193.newLine();
    _builder_193.append("It refers to a {@link State} in the inherited state machine");
    _builder_193.newLine();
    _builder_193.append("which is refined by adding detail code and/or");
    _builder_193.newLine();
    ...
    _builder_195.append("The detail code contains a list of strings which");
    _builder_195.newLine();
    _builder_195.append("are considered verbatim code of the code generator");
    _builder_195.newLine();
    _builder_195.append("target language.");
    _builder_195.newLine();
    _builder_195.newLine();
    _builder_195.append("<p>");
    _builder_195.newLine();
    _builder_195.append("The detail code is parsed by the {@link DetailCodeTranslator}");
    _builder_195.newLine();
    _builder_195.append("which replaces certain frequent constructs like access of members");
    _builder_195.newLine();
    _builder_195.append("and sending a message via a port by target language specific code.");
    _builder_195.newLine();
    _builder_195.append("</p>");
    _builder_195.newLine();
    PostprocessingHelpers.setDocumentation(cls, _builder_195.toString());
    EAttribute _attribute_31 = PostprocessingHelpers.getAttribute(cls, "lines");
    ...
    _builder_197.append("The super class of");
    _builder_197.newLine();
    _builder_197.append("<ul>");
    _builder_197.newLine();
    _builder_197.append("  ");
    _builder_197.append("<li>{@link TransitionPoint}</li>");
    _builder_197.newLine();
    _builder_197.append("  ");
    _builder_197.append("<li>{@link EntryPoint}</li>");
    _builder_197.newLine();
    _builder_197.append("  ");
    _builder_197.append("<li>{@link ExitPoint}</li>");
    _builder_197.newLine();
    _builder_197.append("</ul>");
    _builder_197.newLine();
    ...
    _builder_199.append("A transition point is located at the border of a {@link State}");
    _builder_199.newLine();
    _builder_199.append("and is not visible or accessible outside. It is used");
    _builder_199.newLine();
    _builder_199.append("to globally handle messages. If a {@link Transition} starting");
    _builder_199.newLine();
    _builder_199.append("at a transition point triggers then exit and entry codes");
    _builder_199.newLine();
    _builder_199.append("are executed as usual as long as the handler flag of the");
    _builder_199.newLine();
    ...
    _builder_201.append("An entry point is located at the border of a {@link State}");
    _builder_201.newLine();
    _builder_201.append("and is visible and accessible outside. Outside");
    _builder_201.newLine();
    _builder_201.append("it can be the target of a {@link Transition} and inside the source.");
    _builder_201.newLine();
    _builder_201.append("If it is not connected in the interior then it is a");
    _builder_201.newLine();
    ...
    _builder_202.append("An exit point is located at the border of a {@link State}");
    _builder_202.newLine();
    _builder_202.append("and is visible and accessible outside. Outside");
    _builder_202.newLine();
    _builder_202.append("it can be the source of a {@link Transition} and inside the target.");
    _builder_202.newLine();
    _builder_202.append("If it is not connected in the interior then it is a");
    _builder_202.newLine();
    ...
    _builder_203.append("A choice point corresponds to an {@code if else} construct.");
    _builder_203.newLine();
    _builder_203.append("It is the target of one or more {@link Transition}s and the");
    _builder_203.newLine();
    _builder_203.append("source of several {@link Transition}s.");
    _builder_203.newLine();
    _builder_203.append("One outgoing transitions must be a {@link ContinuationTransition}");
    _builder_203.newLine();
    _builder_203.append("and corresponds to the final else. It is called the");
    _builder_203.newLine();
    _builder_203.append("<em>default branch</em> of the choice point.");
    _builder_203.newLine();
    ...
    _builder_206.append("The super class of");
    _builder_206.newLine();
    _builder_206.append("<ul>");
    _builder_206.newLine();
    _builder_206.append("  ");
    _builder_206.append("<li>{@link InitialTransition}</li>");
    _builder_206.newLine();
    _builder_206.append("  ");
    _builder_206.append("<li>{@link NonInitialTransition}</li>");
    _builder_206.newLine();
    _builder_206.append("</ul>");
    _builder_206.newLine();
    ...
    _builder_211.append("The super class of");
    _builder_211.newLine();
    _builder_211.append("<ul>");
    _builder_211.newLine();
    _builder_211.append("  ");
    _builder_211.append("<li>{@link TransitionChainStartTransition}</li>");
    _builder_211.newLine();
    _builder_211.append("  ");
    _builder_211.append("<li>{@link ContinuationTransition}</li>");
    _builder_211.newLine();
    _builder_211.append("  ");
    _builder_211.append("<li>{@link CPBranchTransition}</li>");
    _builder_211.newLine();
    _builder_211.append("</ul>");
    _builder_211.newLine();
    ...
    _builder_213.append("The super class of");
    _builder_213.newLine();
    _builder_213.append("<ul>");
    _builder_213.newLine();
    _builder_213.append("  ");
    _builder_213.append("<li>{@link TriggeredTransition}</li>");
    _builder_213.newLine();
    _builder_213.append("  ");
    _builder_213.append("<li>{@link GuardedTransition}</li>");
    _builder_213.newLine();
    _builder_213.append("</ul>");
    _builder_213.newLine();
    ...
    _builder_214.append("There can be at most one initial transition in a {@link StateGraph}.");
    _builder_214.newLine();
    _builder_214.append("It defines the starting point of the state graph and is traversed");
    _builder_214.newLine();
    ...
    _builder_215.append("Continuation transitions start at entry or exit points");
    _builder_215.newLine();
    _builder_215.append("({@link EntryPoint}s or {@link ExitPoint}s) or form");
    _builder_215.newLine();
    ...
    _builder_216.append("Triggered transitions start at a {@link State} or a {@link TransitionPoint}.");
    _builder_216.newLine();
    _builder_216.append("It defines a list of {@link Trigger}s that specify the conditions");
    _builder_216.newLine();
    _builder_216.append("when the transition fires and is traversed. This kind of");
    _builder_216.newLine();
    _builder_216.append("transition is only allowed in event driven and mixed (async) state");
    _builder_216.newLine();
    ...
    _builder_218.append("A guarded transition is very similar to a {@link CPBranchTransition}.");
    _builder_218.newLine();
    _builder_218.append("It defines a guard condition which lets the transition fire if");
    _builder_218.newLine();
    _builder_218.append("evaluated to {@code true}. This kind of transition is only");
    _builder_218.newLine();
    ...
    _builder_220.append("The choice point branch transitions is allowed only as outgoing");
    ...
    _builder_222.append("The refined transition is only allowed in {@link StateGraph}s");
    _builder_222.newLine();
    _builder_222.append("of derived {@link ActorClass}es. It targets a {@link Transition}");
    _builder_222.newLine();
    ...
    _builder_226.append("The super class of");
    _builder_226.newLine();
    _builder_226.append("<ul>");
    _builder_226.newLine();
    _builder_226.append("  ");
    _builder_226.append("<li>{@link StateTerminal}</li>");
    _builder_226.newLine();
    _builder_226.append("  ");
    _builder_226.append("<li>{@link TrPointTerminal}</li>");
    _builder_226.newLine();
    _builder_226.append("  ");
    _builder_226.append("<li>{@link SubStateTrPointTerminal}</li>");
    _builder_226.newLine();
    _builder_226.append("  ");
    _builder_226.append("<li>{@link ChoicepointTerminal}</li>");
    _builder_226.newLine();
    _builder_226.append("</ul>");
    _builder_226.newLine();
    ...
    _builder_227.append("The terminal point (source or target) of a transition ending");
    ...
    _builder_229.append("The terminal point (source or target) of a transition ending");
    ...
    _builder_231.append("The terminal point (source or target) of a transition ending");
    ...
    _builder_236.append("A transition trigger is a list of {@link MessageFromIf} pairs");
    ...
    _builder_239.append("A pair consisting of a {@link Message} arising from an");
    ...
    _builder_242.append("A detail code that evaluates to a boolean in the target");
    ...
    EClass _class_78 = PostprocessingHelpers.getClass(pckg, "Import");
    cls = _class_78;
    StringConcatenation _builder_244 = new StringConcatenation();
    _builder_244.append("The import declares an imported model (given as a URI) and");
    _builder_244.newLine();
    _builder_244.append("an optional imported namespace.");
    _builder_244.newLine();
    PostprocessingHelpers.setDocumentation(cls, _builder_244.toString());
    EAttribute _attribute_36 = PostprocessingHelpers.getAttribute(cls, "importedNamespace");
    StringConcatenation _builder_245 = new StringConcatenation();
    _builder_245.append("The imported name space has to be a dot separated qualified name followed by .*.");
    _builder_245.newLine();
    _builder_245.append("Example: my.namespace.*");
    _builder_245.newLine();
    PostprocessingHelpers.setDocumentation(_attribute_36, _builder_245.toString());
    EAttribute _attribute_37 = PostprocessingHelpers.getAttribute(cls, "importURI");
    StringConcatenation _builder_246 = new StringConcatenation();
    _builder_246.append("The import URI can be a relative or absolute file system path.");
    _builder_246.newLine();
    _builder_246.append("It may contain environment variables in ${} which will be expanded.");
    _builder_246.newLine();
    _builder_246.append("<p>");
    _builder_246.newLine();
    _builder_246.append("Examples:");
    _builder_246.newLine();
    _builder_246.append("<ul>");
    _builder_246.newLine();
    _builder_246.append("  ");
    _builder_246.append("<li>import model \"AnotherModel.room\"</li>");
    _builder_246.newLine();
    _builder_246.append("  ");
    _builder_246.append("<li>import my.namespace.* from \"AnotherModel.room\"</li>");
    _builder_246.newLine();
    _builder_246.append("  ");
    _builder_246.append("<li>import my.namespace.* from \"../../AnotherProject/models/AnotherModel.room\"</li>");
    _builder_246.newLine();
    _builder_246.append("  ");
    _builder_246.append("<li>import my.namespace.* from \"/${ROOM_MODELS}/SomeModel.room\"</li>");
    _builder_246.newLine();
    _builder_246.append("</ul>");
    _builder_246.newLine();
    _builder_246.append("</p>");
    _builder_246.newLine();
    PostprocessingHelpers.setDocumentation(_attribute_37, _builder_246.toString());
  }
}
