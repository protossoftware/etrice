        ...
        for(final Message message : messages) {
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_notEquals_1) {
              ...
              _builder.append("((etReplSubPort*)&((etReplPort*)self)->ports[i]");
              ...
              String _sendMessageCall_1 = this.sendMessageCall(hasData, "((etReplSubPort*)&((etReplPort*)self)->ports[i])", _memberInUse_1, _plus_7, _plus_8);
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_generateMSCInstrumentation_1) {
                  _builder.append("\t");
                  _builder.append("\t");
                  _builder.append("ET_MSC_LOGGER_ASYNC_OUT(((etReplSubPort*)&((etReplPort*)self)->ports[i])->myInstName, \"");
                  String _name_10 = message.getName();
                  _builder.append(_name_10, "		");
                  _builder.append("\", ((etReplSubPort*)&((etReplPort*)self)->ports[i])->peerInstName )");
                  _builder.newLineIfNotEmpty();
                }
              }
              _builder.append("\t");
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_notEquals_2) {
              ...
              _builder.append("((etReplSubPort*)&((etReplPort*)self)->ports[idx]");
              _builder.append(dataCall, "	");
              _builder.append(");");
              _builder.newLineIfNotEmpty();
            } else {
              ...
              String _sendMessageCall_2 = this.sendMessageCall(hasData, "((etReplSubPort*)&((etReplPort*)self)->ports[idx])", _memberInUse_2, _plus_11, _plus_12);
              ...
              _builder.newLineIfNotEmpty();
              {
                ...
                if (_generateMSCInstrumentation_2) {
                  _builder.append("\t");
                  _builder.append("\t");
                  _builder.append("ET_MSC_LOGGER_ASYNC_OUT(((etReplSubPort*)&((etReplPort*)self)->ports[idx])->myInstName, \"");
                  String _name_16 = message.getName();
                  _builder.append(_name_16, "		");
                  _builder.append("\", ((etReplSubPort*)&((etReplPort*)self)->ports[idx])->peerInstName )");
                  _builder.newLineIfNotEmpty();
                }
              }
              _builder.append("\t");
