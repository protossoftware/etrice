...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Open Binding</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class OpenBindingImpl extends EObjectImpl implements OpenBinding {
		...
		if (port != null && port.eIsProxy()) {
			...
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ETriceGenPackage.OPEN_BINDING__PORT, oldPort, port));
			}
		}
		return port;
	}
	...
	public void setPort(Port newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ETriceGenPackage.OPEN_BINDING__PORT, oldPort, port));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ETriceGenPackage.OPEN_BINDING__PATH:
				return getPath();
			case ETriceGenPackage.OPEN_BINDING__PORT:
	...
	public String toString() {
		...
		result.append("OpenBinding: ");
		result.append(getPort().getName());
		result.append(' ');
