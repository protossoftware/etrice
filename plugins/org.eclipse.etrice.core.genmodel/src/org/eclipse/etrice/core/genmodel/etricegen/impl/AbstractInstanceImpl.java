 ...
 * @generated
 */
public abstract class AbstractInstanceImpl extends InstanceBaseImpl implements AbstractInstance {
	...
	protected EClass eStaticClass() {
		return ETriceGenPackage.Literals.ABSTRACT_INSTANCE;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ETriceGenPackage.ABSTRACT_INSTANCE__PORTS:
