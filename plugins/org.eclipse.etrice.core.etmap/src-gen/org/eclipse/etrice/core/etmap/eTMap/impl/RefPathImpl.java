 ...
 * <ul>
 *   <li>{@link org.eclipse.etrice.core.etmap.eTMap.impl.RefPathImpl#getRefs <em>Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefPathImpl extends MinimalEObjectImpl.Container implements RefPath
{
  ...
  {
    return ETMapPackage.Literals.REF_PATH;
  }
  ...
  public EList<String> getRefs()
  {
    if (refs == null)
    {
      refs = new EDataTypeEList<String>(String.class, this, ETMapPackage.REF_PATH__REFS);
    }
    return refs;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ETMapPackage.REF_PATH__REFS:
        return getRefs();
    }
