...
public class ProjectFileFragments {
  ...
  public static String getMavenPOM(final String project, final String mdlName, final String mainClass) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("<version>0.0.1</version>");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<groupId>org.eclipse.etrice.runtime.java</groupId>");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t  \t\t");
    _builder.append("<groupId>org.eclipse.etrice.modellib.java</groupId>");
    _builder.newLine();
    _builder.append("\t  \t\t");
