...
public class ProjectFileFragments {
  public static String getBasicRoomModel(final String baseName) {
    ...
    _builder.append("RoomModel �baseName� {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("LogicalSystem �baseName� {");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public static String getBasicPhysicalModel(final String baseName) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("PhysicalModel �baseName� {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
  ...
  public static String getBasicMappingModel(final String baseName) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("MappingModel �baseName� {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("import �baseName�.* from \"�baseName�.room\"");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("import �baseName�.* from \"�baseName�.etphys\"");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("Mapping �baseName� -> PhysSys1 {");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public static String getGeneratorLaunchConfig(final String targetLanguage, final String modelPath, final String baseName, final String[] addLines) {
    String _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("<launchConfiguration type=\"org.eclipse.etrice.generator.launch.�targetLanguage�.launchConfigurationType\">");
      _builder.newLine();
      _builder.append("<booleanAttribute key=\"MSC\" value=\"true\"/>");
      _builder.newLine();
      _builder.append("<booleanAttribute key=\"UseTranslation\" value=\"�useTranslation�\"/>");
      _builder.newLine();
      _builder.append("<listAttribute key=\"ModelFiles\">");
      _builder.newLine();
      _builder.append("<listEntry value=\"${workspace_loc:�modelPath�/�baseName�.etmap}\"/>");
      _builder.newLine();
      ...
      _builder.append("</listAttribute>");
      _builder.newLine();
      _builder.append("�FOR line : addLines�");
      _builder.newLine();
      _builder.append("\t");
  ...
  public static String getLaunchJavaApplicationConfig(final String project, final String mdlName, final String mainClass) {
    ...
    _builder.newLine();
    _builder.append("<listEntry value=\"/�project�/src-gen/�mdlName.replace(\'.\', \'/\')�/�mainClass�.java\"/>");
    _builder.newLine();
    _builder.append("</listAttribute>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.jdt.launching.MAIN_TYPE\" value=\"�mdlName�.�mainClass�\"/>");
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.jdt.launching.PROJECT_ATTR\" value=\"�project�\"/>");
    _builder.newLine();
    _builder.append("</launchConfiguration>");
    _builder.newLine();
    return _builder.toString();
  ...
  public static String getLaunchCApplicationConfig(final String project) {
    ...
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.cdt.launch.PROGRAM_NAME\" value=\"Debug/�project�.exe\"/>");
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.cdt.launch.PROJECT_ATTR\" value=\"�project�\"/>");
    _builder.newLine();
    _builder.append("<booleanAttribute key=\"org.eclipse.cdt.launch.use_terminal\" value=\"true\"/>");
    _builder.newLine();
    _builder.append("<listAttribute key=\"org.eclipse.debug.core.MAPPED_RESOURCE_PATHS\">");
    _builder.newLine();
    _builder.append("<listEntry value=\"/�project�\"/>");
    _builder.newLine();
    _builder.append("</listAttribute>");
    _builder.newLine();
    _builder.append("<listAttribute key=\"org.eclipse.debug.core.MAPPED_RESOURCE_TYPES\">");
  ...
  public static String getMavenPOM(final String project, final String mdlName, final String mainClass) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<groupId>�project�</groupId>");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<artifactId>�mdlName�</artifactId>");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t          \t");
    _builder.append("<param>model/�mdlName�.etmap</param>");
    _builder.newLine();
    _builder.append("\t\t\t\t          ");
    _builder.append("</arguments>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("<mainClass>�mdlName�.�mainClass�</mainClass>");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("</manifest>");
    _builder.newLine();
  ...
  public static String getMavenBuilder(final String project) {
    ...
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.jdt.launching.WORKING_DIRECTORY\" value=\"${workspace_loc:/�project�}\"/>");
    _builder.newLine();
    _builder.append("</launchConfiguration>");
    _builder.newLine();
    return _builder.toString();
  ...
  public static String getMavenLauncher(final String project, final String mdlName) {
    ...
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.ui.externaltools.ATTR_TOOL_ARGUMENTS\" value=\"-jar target/�mdlName�-1.0.0-jar-with-dependencies.jar\"/>");
    _builder.newLine();
    _builder.append("<stringAttribute key=\"org.eclipse.ui.externaltools.ATTR_WORKING_DIRECTORY\" value=\"${workspace_loc:/�project�}\"/>");
    _builder.newLine();
    _builder.append("</launchConfiguration>");
    _builder.newLine();
    return _builder.toString();
